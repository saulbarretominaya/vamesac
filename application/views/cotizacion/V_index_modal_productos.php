                             ...
                             <div class="form-group row">
                                 <div class="col-md-12">
                                     <div class="input-group">
                                         ...
                                         <div class="col-md-8">
                                             <?php echo $index_modal_cabecera_productos->fecha_emision; ?>
                                         </div>
                                     </div>
                                 </div>
                                 <div class="col-md-12">
                                     <div class="input-group">
                                         ...
                                         <div class="col-md-8">
                                             <?php echo $index_modal_cabecera_productos->validez_oferta_cotizacion; ?>
                                         </div>
                                     </div>
                                 </div>
                                 <div class="col-md-12">
                                     <div class="input-group">
                                         ...
                                         <div class="col-md-8">
                                             <?php echo $index_modal_cabecera_productos->fecha_vencimiento_validez_oferta; ?>
                                         </div>
                                     </div>
                                 </div>
                                 <div class="col-md-12">
