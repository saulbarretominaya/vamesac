...
$fpdf->SetY(27);
$fpdf->SetX(168);
$fpdf->Write(0, 'COT - ' . $index_modal_cabecera_productos->id_cotizacion_empresa);
// $fpdf->Write(0, '');
...
$fpdf->Write(0, $index_modal_cabecera_productos->fecha_emision);
$fpdf->Write(0, '');
$fpdf->SetY(44);
$fpdf->SetX(10);
$fpdf->setFont('Arial', 'B', 8);
...
$fpdf->Write(0, 'Christian Hidalgo');
...
$fpdf->Write(0, 'chidalgo@vamesac.pe');
...
$fpdf->Cell(28, 4,  'S/ ' . $index_modal_cabecera_productos->valor_venta_total_sin_d, 1, 0, 'L', 1);
// $fpdf->Cell(28, 4,  '');
...
$fpdf->Cell(28, 4, 'S/ ' . $index_modal_cabecera_productos->descuento_total, 1, 0, 'L', 1);
// $fpdf->Cell(28, 4, '');
...
$fpdf->Cell(28, 4, 'S/ ' . $index_modal_cabecera_productos->valor_venta_total_con_d, 1, 0, 'L', 1);
// $fpdf->Cell(28, 4, '');
...
$fpdf->Cell(28, 4, 'S/ ' . $index_modal_cabecera_productos->igv, 1, 0, 'L', 1);
// $fpdf->Cell(28, 4, '');
...
$fpdf->Cell(28, 4, 'S/ ' . $index_modal_cabecera_productos->precio_venta, 1, 0, 'L', 1);
// $fpdf->Cell(28, 4, '');
...
// $fpdf->Ln(4);
$fpdf->OutPut('I', 'COT - ' . $index_modal_cabecera_productos->id_cotizacion_empresa . '.pdf'); //Destino [I,D,F,S], nombre del archivo,

// $fpdf->OutPut('I', ''); //Destino [I,D,F,S], nombre del archivo,
