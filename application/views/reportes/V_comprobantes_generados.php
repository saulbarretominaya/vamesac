  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Reportes de Facturas y Boletas Emitidas 
            </h1>
          </div>
        </div>
      </div>
    ...
    <section class="content">
      ...
      <div class="col-md-12">
        <div class="col-sm-6">
            <h3>Reportes de Nota de Credito y Debito Emitidas 
            </h3>
          </div>
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Listar Reportes de Nota de Credito y Debito Emitidas </h3>
            <div class="card-tools">
              <button type="button" class="btn btn-tool" data-card-widget="collapse">
                <i class="fas fa-plus"></i>
              </button>
