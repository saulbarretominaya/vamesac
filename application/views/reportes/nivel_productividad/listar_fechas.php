...
$fpdf->SetY(37);
$fpdf->SetX(10);
$fpdf->SetWidths(array(15, 30, 40, 60, 50));
$fpdf->SetDrawColor(237, 232, 228); //color de la linea
$fpdf->setFillColor(237, 232, 228); //Para poner relleno

$fpdf->Cell(15, 8, 'Item', 1, 0, 'L', 1);
$fpdf->Cell(30, 8, 'Fecha', 1, 0, 'L', 1);
$fpdf->Cell(40, 8, 'Total de ventas diarias', 1, 0, 'L', 1);
$fpdf->Cell(60, 8, 'Ventas por horas trabajadas al dia (VHT)', 1, 0, 'L', 1);
$fpdf->Cell(50, 8, 'Productividad en ventas (PV)', 1, 0, 'L', 1);
$fpdf->Ln(8);
...
foreach ($listar_fechas as $index) {
    $fpdf->Row(array(
        ...
        $index->fecha_emision,
        $index->precio_venta,
        $index->horas_trabajadas,
        $index->nivel_productividad
    ));
}

$fpdf->OutPut('I', 'nivel_productividad.pdf'); //Destino [I,D,F,S], nombre del archivo,
