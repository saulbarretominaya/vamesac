                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      <input type="hidden" class="form-control" id="id_usuario" value="<?php echo $enlace_actualizar->id_usuario; ?>">
                      <input type="hidden" class="form-control" id="id_trabajador" value="<?php echo $enlace_actualizar->id_trabajador; ?>">
                      <input type="text" class="form-control" id="ds_nombre_trabajador" value="<?php echo $enlace_actualizar->ds_nombre_usuario; ?>" readonly>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="input-group">
                      <input class="form-control" type="hidden" class="form-control" id="ds_empresa" value="<?php echo $enlace_actualizar->ds_trabaja_rrhh; ?>" readonly>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <!-- <label>Sucursal</label> -->
                    <div class="input-group">
                      <input class="form-control" type="hidden" class="form-control" id="ds_almacen" value="<?php echo $enlace_actualizar->ds_sucursal; ?>" readonly>
                    </div>
                  </div>
